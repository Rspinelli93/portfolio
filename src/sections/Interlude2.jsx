...
const Interlude2 = () => {    
    return (
        <div id="interlude2" className="section-div-dotted-right">
            <div className="interlude2-container">
                <div className="interlude2-top">
                    <img src="src\assets\coding3.jpg" alt="coding_img_3" />
